...
## Bloc 1 : verification avant creation du tag
...
## Bloc 2 : creation future manuelle du tag, documentee uniquement

- git tag -a agicore-trading-v1-offline -m "AGIcore Trading v1 Offline - sandbox release"

## Bloc 3 : push futur manuel du tag, documente uniquement

- git push origin agicore-trading-v1-offline

## Bloc 4 : verification apres push du tag, documentee uniquement
