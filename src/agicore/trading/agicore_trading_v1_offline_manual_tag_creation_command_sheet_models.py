"""Models for AGIcore Trading v1 offline manual tag creation command sheet."""
...
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetState(StrEnum):
    NOT_READY = "NOT_READY"
    AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_INPUT_INVALID = (
        "AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_INPUT_INVALID"
    )
    AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_BLOCKED = (
        "AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_BLOCKED"
    )
    AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_COMPLETED_WITH_WARNINGS = (
        "AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_COMPLETED_WITH_WARNINGS"
    )
    AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_COMPLETED = (
        "AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_COMPLETED"
    )
    READY_FOR_AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_REVIEW = (
        "READY_FOR_AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_REVIEW"
    )


class AGIcoreTradingV1OfflineManualTagCreationCommandSheetDecision(StrEnum):
    BLOCK_AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET = (
        "BLOCK_AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_INPUT_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_INPUT_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_PREREQUISITE_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_PREREQUISITE_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_NAME_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_NAME_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_VERSION_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_VERSION_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_PRE_TAG_COMMAND_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_PRE_TAG_COMMAND_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_EXPECTED_RESULT_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_EXPECTED_RESULT_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_COMMAND_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_COMMAND_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_STOP_RULE_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_STOP_RULE_FIXES"
    )
    REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_NO_OVERCLAIM_FIXES = (
        "REQUIRE_MANUAL_TAG_CREATION_COMMAND_SHEET_NO_OVERCLAIM_FIXES"
    )
...
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetRisk(StrEnum):
    MANUAL_TAG_CREATION_COMMAND_SHEET_INPUT_MISSING = "MANUAL_TAG_CREATION_COMMAND_SHEET_INPUT_MISSING"
    MANUAL_TAG_CREATION_COMMAND_SHEET_PREREQUISITES_INCOMPLETE = (
        "MANUAL_TAG_CREATION_COMMAND_SHEET_PREREQUISITES_INCOMPLETE"
    )
    ...
    MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_NAME_INVALID = "MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_NAME_INVALID"
    MANUAL_TAG_CREATION_COMMAND_SHEET_VERSION_INVALID = "MANUAL_TAG_CREATION_COMMAND_SHEET_VERSION_INVALID"
    MANUAL_TAG_CREATION_COMMAND_SHEET_PRE_TAG_COMMANDS_MISSING = (
        "MANUAL_TAG_CREATION_COMMAND_SHEET_PRE_TAG_COMMANDS_MISSING"
    )
    MANUAL_TAG_CREATION_COMMAND_SHEET_EXPECTED_RESULTS_MISSING = (
        "MANUAL_TAG_CREATION_COMMAND_SHEET_EXPECTED_RESULTS_MISSING"
    )
    MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_COMMANDS_NOT_DOCUMENTATION_ONLY = (
        "MANUAL_TAG_CREATION_COMMAND_SHEET_TAG_COMMANDS_NOT_DOCUMENTATION_ONLY"
    )
    MANUAL_TAG_CREATION_COMMAND_SHEET_STOP_RULES_MISSING = (
        "MANUAL_TAG_CREATION_COMMAND_SHEET_STOP_RULES_MISSING"
    )
...
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetRecommendation(StrEnum):
    PREPARE_COMMAND_SHEET_REVIEW = "PREPARE_COMMAND_SHEET_REVIEW"
    PROVIDE_COMMAND_SHEET_INPUT = "PROVIDE_COMMAND_SHEET_INPUT"
    RESTORE_COMMAND_SHEET_PREREQUISITES = "RESTORE_COMMAND_SHEET_PREREQUISITES"
    ...
    RESTORE_COMMAND_SHEET_TAG_NAME = "RESTORE_COMMAND_SHEET_TAG_NAME"
    RESTORE_COMMAND_SHEET_VERSION = "RESTORE_COMMAND_SHEET_VERSION"
    RESTORE_PRE_TAG_COMMANDS = "RESTORE_PRE_TAG_COMMANDS"
    RESTORE_EXPECTED_PRE_TAG_RESULTS = "RESTORE_EXPECTED_PRE_TAG_RESULTS"
...
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetScore:
    overall_score: int
    input_score: int
...
@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetCommand:
    command: str
    block: str
    present: bool = True
...
@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetExpectedResult:
    result: str
    present: bool = True


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetStopRule:
    rule: str
    present: bool = True


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetTagMetadata:
    tag_name: str
    version: str


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetContext:
    sheet_id: str
    tag_metadata: AGIcoreTradingV1OfflineManualTagCreationCommandSheetTagMetadata
    prerequisites: tuple[str, ...]
    pre_tag_commands: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetCommand, ...]
    expected_pre_tag_results: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetExpectedResult, ...]
    tag_creation_commands: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetCommand, ...]
    tag_push_commands: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetCommand, ...]
    post_tag_commands: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetCommand, ...]
    stop_rules: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetStopRule, ...]


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetReport:
    markdown: str
    json: str


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetInput:
    sheet_id: str = "agicore-trading-v1-offline-manual-tag-creation-command-sheet"
...
@dataclass(frozen=True)
class AGIcoreTradingV1OfflineManualTagCreationCommandSheetResult:
    ...
    score: AGIcoreTradingV1OfflineManualTagCreationCommandSheetScore
    risks: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetRisk, ...]
    recommendations: tuple[AGIcoreTradingV1OfflineManualTagCreationCommandSheetRecommendation, ...]
    context: AGIcoreTradingV1OfflineManualTagCreationCommandSheetContext | None = None
    report: AGIcoreTradingV1OfflineManualTagCreationCommandSheetReport | None = None
    ...
    next_phase: str = "AGICORE_TRADING_V1_OFFLINE_MANUAL_TAG_CREATION_COMMAND_SHEET_REVIEW"
