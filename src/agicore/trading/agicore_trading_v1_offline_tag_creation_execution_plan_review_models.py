"""Models for AGIcore Trading v1 offline tag creation execution plan review."""
...
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewState(StrEnum):
    NOT_READY = "NOT_READY"
    AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT_INVALID = (
        "AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT_INVALID"
    )
    AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_BLOCKED = (
        "AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_BLOCKED"
    )
    AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_COMPLETED_WITH_WARNINGS = (
        "AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_COMPLETED_WITH_WARNINGS"
    )
    AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_COMPLETED = (
        "AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW_COMPLETED"
    )
    READY_FOR_AGICORE_TRADING_V1_OFFLINE_FINAL_MANUAL_TAG_AUTHORIZATION = (
        "READY_FOR_AGICORE_TRADING_V1_OFFLINE_FINAL_MANUAL_TAG_AUTHORIZATION"
    )


class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewDecision(StrEnum):
    BLOCK_AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW = (
        "BLOCK_AGICORE_TRADING_V1_OFFLINE_TAG_CREATION_EXECUTION_PLAN_REVIEW"
    )
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT_FIXES = "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT_FIXES"
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_PREREQUISITE_FIXES = (
        "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_PREREQUISITE_FIXES"
    )
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_TAG_NAME_FIXES = (
        "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_TAG_NAME_FIXES"
    )
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_VERSION_FIXES = (
        "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_VERSION_FIXES"
    )
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STEP_FIXES = "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STEP_FIXES"
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_COMMAND_DOCUMENTATION_FIXES = (
        "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_COMMAND_DOCUMENTATION_FIXES"
    )
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STOP_RULE_FIXES = (
        "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STOP_RULE_FIXES"
    )
    REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_NO_OVERCLAIM_FIXES = (
        "REQUIRE_TAG_CREATION_EXECUTION_PLAN_REVIEW_NO_OVERCLAIM_FIXES"
    )
...
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewRisk(StrEnum):
    TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT_MISSING = "TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT_MISSING"
    TAG_CREATION_EXECUTION_PLAN_NOT_APPROVED = "TAG_CREATION_EXECUTION_PLAN_NOT_APPROVED"
    TAG_CREATION_EXECUTION_PLAN_REVIEW_PREREQUISITES_INCOMPLETE = (
        "TAG_CREATION_EXECUTION_PLAN_REVIEW_PREREQUISITES_INCOMPLETE"
    )
    ...
    TAG_CREATION_EXECUTION_PLAN_REVIEW_TAG_NAME_INVALID = (
        "TAG_CREATION_EXECUTION_PLAN_REVIEW_TAG_NAME_INVALID"
    )
    TAG_CREATION_EXECUTION_PLAN_REVIEW_VERSION_INVALID = "TAG_CREATION_EXECUTION_PLAN_REVIEW_VERSION_INVALID"
    TAG_CREATION_EXECUTION_PLAN_REVIEW_STEPS_MISSING = "TAG_CREATION_EXECUTION_PLAN_REVIEW_STEPS_MISSING"
    TAG_CREATION_EXECUTION_PLAN_REVIEW_COMMANDS_NOT_DOCUMENTATION_ONLY = (
        "TAG_CREATION_EXECUTION_PLAN_REVIEW_COMMANDS_NOT_DOCUMENTATION_ONLY"
    )
    TAG_CREATION_EXECUTION_PLAN_REVIEW_LOCAL_CHECKS_MISSING = (
        "TAG_CREATION_EXECUTION_PLAN_REVIEW_LOCAL_CHECKS_MISSING"
    )
    TAG_CREATION_EXECUTION_PLAN_REVIEW_REMOTE_CHECKS_MISSING = (
        "TAG_CREATION_EXECUTION_PLAN_REVIEW_REMOTE_CHECKS_MISSING"
    )
    TAG_CREATION_EXECUTION_PLAN_REVIEW_STOP_RULES_MISSING = (
        "TAG_CREATION_EXECUTION_PLAN_REVIEW_STOP_RULES_MISSING"
    )
...
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewRecommendation(StrEnum):
    PROVIDE_TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT = "PROVIDE_TAG_CREATION_EXECUTION_PLAN_REVIEW_INPUT"
    RESTORE_TAG_CREATION_EXECUTION_PLAN_APPROVAL = "RESTORE_TAG_CREATION_EXECUTION_PLAN_APPROVAL"
    RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_PREREQUISITES = (
        "RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_PREREQUISITES"
    )
    ...
    RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_TAG_NAME = (
        "RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_TAG_NAME"
    )
    RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_VERSION = "RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_VERSION"
    RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STEPS = "RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STEPS"
    KEEP_TAG_CREATION_REVIEW_COMMANDS_DOCUMENTATION_ONLY = (
        "KEEP_TAG_CREATION_REVIEW_COMMANDS_DOCUMENTATION_ONLY"
    )
    RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_LOCAL_CHECKS = (
        "RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_LOCAL_CHECKS"
    )
    RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_REMOTE_CHECKS = (
        "RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_REMOTE_CHECKS"
    )
    RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STOP_RULES = (
        "RESTORE_TAG_CREATION_EXECUTION_PLAN_REVIEW_STOP_RULES"
    )
    ...
    PREPARE_AGICORE_TRADING_V1_OFFLINE_FINAL_MANUAL_TAG_AUTHORIZATION = (
        "PREPARE_AGICORE_TRADING_V1_OFFLINE_FINAL_MANUAL_TAG_AUTHORIZATION"
    )


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewScore:
    overall_score: int
    input_score: int
    approval_score: int
...
@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewPrerequisite:
    name: str
    approved: bool = True


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewCriterion:
    name: str
    passed: bool = True


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewFinding:
    name: str
    passed: bool
    detail: str
...
@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewCommand:
    command: str
    documentation_only: bool = True


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewStopRule:
    rule: str
    present: bool = True


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewTagMetadata:
    tag_name: str
    version: str


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewContext:
    review_id: str
    tag_metadata: AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewTagMetadata
    prerequisites: tuple[AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewPrerequisite, ...]
    criteria: tuple[AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewCriterion, ...]
    commands: tuple[AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewCommand, ...]
    stop_rules: tuple[AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewStopRule, ...]


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewReport:
    markdown: str
    json: str


@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewInput:
    review_id: str = "agicore-trading-v1-offline-tag-creation-execution-plan-review"
    ...
    local_checks_present: bool = True
...
@dataclass(frozen=True)
class AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewResult:
    ...
    score: AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewScore
    risks: tuple[AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewRisk, ...]
    recommendations: tuple[AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewRecommendation, ...]
    context: AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewContext | None = None
    findings: tuple[AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewFinding, ...] = ()
    report: AGIcoreTradingV1OfflineTagCreationExecutionPlanReviewReport | None = None
    ...
    next_phase: str = "AGICORE_TRADING_V1_OFFLINE_FINAL_MANUAL_TAG_AUTHORIZATION"
