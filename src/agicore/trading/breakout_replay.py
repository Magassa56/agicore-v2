    ...
    for i, bar in enumerate(ordered):
        if pending:
            ...
            if pending_kind == "EXIT":
                trades.append(_close(pos, bar, i, "SIGNAL_REVERSAL", config.round_trip_cost_points)); pos=None
